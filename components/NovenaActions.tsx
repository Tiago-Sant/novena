		...
		<div className="flex flex-col gap-4 sm:gap-6">
			<div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
				<div className="flex gap-2 sm:gap-3">
					<button
						onClick={() =>
							setSelectedDay(paramsSlug, Math.max(1, displayDayNumber - 1))
						}
					...
					<button
						onClick={() =>
							setSelectedDay(
								paramsSlug,
								Math.min(currentDayNumber, displayDayNumber + 1),
							)
						}
			...
			<div className="flex flex-col sm:flex-row sm:items-center gap-3">
				...
				>
					{novenaInstance.completedDays.includes(current.day)
						? 'Desmarcar como rezado'
						: 'Marcar como rezado'}
				</button>
