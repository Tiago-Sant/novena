export const santaTeresinhaNovena = {
	...
	icon: '🌹',
	description:
		'Santa Teresinha promete enviar uma rosa como sinal de que a graça será concedida. Esta novena consiste na mesma oração rezada por 9 dias consecutivos, seguida de 24 Glórias ao Pai.',
	celebration: 'Dia que se celebra Santa Teresinha - 1º de outubro',
	experience:
		'Comece sua novena em qualquer data, mas para uma experiência especial, considere iniciá-la no dia 22 de setembro, terminando no dia 1º de outubro.',
	...
	prayer: `Em nome do Pai, do Filho e do Espírito Santo. Amém.
        ...
        Ajudai minha fé e minha esperança, ó Santa Teresinha, cumprindo, mais uma vez, sua promessa de que ninguém vos invocaria em vão, fazendo-me ganhar uma rosa, sinal de que alcançarei a graça pedida. Amém.
