export const beatoPadreEustaquioNovena = {
	slug: 'beato-padre-eustaquio',
	name: 'Novena ao Beato Padre Eustáquio',
	color: 'bg-amber-50',
	border: 'border border-amber-200',
	rounded: 'rounded-lg',
	icon: '❤️',
	description:
		'Marcado por intensa mística e devoção à Virgem Maria e a São José, o "Vigário de Poá" realizou prodígios extraordinários como clarividência, bilocação e curas de multidões. Homem de profunda escuta e caridade, dedicava horas ao confessionário e ao socorro dos necessitados. É um poderoso intercessor para casos difíceis, enfermidades do corpo e aflições espirituais.',
	celebration: 'Dia que se celebra Beato Padre Eustáquio: 30 de agosto',
	experience:
...
Eu renovo meus compromissos do Batismo de viver como bom cristão. Prometo rezar e colaborar para que em breve sejais reconhecido como Santo para maior honra e glória dos Sagrados Corações de Jesus e de Maria e da Santa Igreja.

Amém!`,
	finallyPrayer: `Pai-nosso; Ave-Maria; Glória;
...
Beato Padre Eustáquio, rogai por nós!`,
		...
		{
			day: 9,
			title: 'Padre Eustáquio e a Eucaristia',
			meditation: `Como jovem Padre Eustáquio caminhava bem cedo, por mais de uma hora para participar da Santa Missa e comungar. Como religioso dos Sagrados Corações e da Adoração Perpétua, diariamente se recolhia diante do Santíssimo Sacramento. Como sacerdote procurava viver e levar os fiéis a centrar toda a sua vida na Eucaristia.`,
			prayerOfDay: `Meu grande benfeitor, Padre Eustáquio, inspirai-me o vosso amor à Sagrada Eucaristia, a qual vos alimentou todos os dias e vos deu tanta força em vosso apostolado. Suplico-vos conceder-me o desejo do Pão Eucarístico, que nos é oferecido diariamente na Missa e que a minha adoração me faça um intercessor pela humanidade. Amém`,
		},
	],
};
